...
class JPELSortTest {
    ...
    void sortAscendingNumbers() {
        ...
        Object result = JPEL.eval("products | sort(price)", shop);
    ...
    void sortDescendingNumbers() {
        ...
        Object result = JPEL.eval("products | sort(price desc)", shop);
        List<?> sorted = (List<?>) result;
    ...
    void sortStrings() {
        ...
        Object result = JPEL.eval("persons | sort(name)", party);
        List<?> sorted = (List<?>) result;
    ...
    void sortStringsDescending() {
        ...
        Object result = JPEL.eval("persons | sort(name desc)", party);
        List<?> sorted = (List<?>) result;
    ...
    void sortFiltered() {
        ...
        Object result = JPEL.eval("persons[age >= 18] | sort(age)", party);
        List<?> sorted = (List<?>) result;
    ...
    void sortExplicitAscending() {
        ...
        Object result = JPEL.eval("products | sort(price asc)", shop);
        List<?> sorted = (List<?>) result;
    ...
    void sortWithNulls() {
        ...
        Object result = JPEL.eval("persons | sort(address.city)", party);
        List<?> sorted = (List<?>) result;
    ...
    void sortThenAggregate() {
        ...
        Object result = JPEL.eval("persons | sort(age) | count()", party);
    ...
    void sortWithParameter() {
        ...
        Expression expr = JPEL.compile("products[price >= :minPrice] | sort(price desc)");
