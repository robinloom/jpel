...
class JPELOptionalTest {
    ...
    void getOptionalResultWithValue() {
        ...
        Optional<String> result = JPEL.compile("persons[0].address.city")
    ...
    void getOptionalResultWithEmptyList() {
        ...
        Optional<Person> result = JPEL.compile("persons[age >= 18]")
    ...
    void getOptionalResultWithNoMatch() {
        ...
        Optional<Person> result = JPEL.compile("persons[age > 30]")
            .getOptionalResult(party, Person.class);
    ...
    void getOptionalResultWithMultipleMatches() {
        ...
        Expression expr = JPEL.compile("persons[age >= 17]");
    ...
    void getOptionalResultWithSingleMatch() {
        ...
        Optional<Person> result = JPEL.compile("persons[age == 20]")
            .getOptionalResult(party, Person.class);
    ...
    void getOptionalResultChaining() {
        ...
        Optional<String> city = JPEL.compile("persons[age >= 18].address.city")
            .getOptionalResult(party, String.class);
    ...
    void getOptionalResultWithDefault() {
        ...
        String city = JPEL.compile("persons[0].address.city")
            .getOptionalResult(party, String.class)
            .orElse("Unknown");
    ...
    void getOptionalResultWithParameter() {
        ...
        Optional<String> city = JPEL.compile("persons[name == :targetName].address.city")
