...
class JPELAggregationTest {
    ...
    void countAll() {
        ...
        Object result = JPEL.eval("persons | count()", party);
    ...
    void countFiltered() {
        ...
        Object result = JPEL.eval("persons[age >= 18] | count()", party);
    ...
    void sumField() {
        ...
        Object result = JPEL.eval("products | sum(price)", shop);
    ...
    void sumFieldFiltered() {
        ...
        Object result = JPEL.eval("products[price > 30] | sum(price)", shop);
    ...
    void avgField() {
        ...
        Object result = JPEL.eval("persons | avg(age)", party);
    ...
    void minField() {
        ...
        Object result = JPEL.eval("products | min(price)", shop);
    ...
    void maxField() {
        ...
        Object result = JPEL.eval("products | max(price)", shop);
    ...
    void minStringField() {
        ...
        Object result = JPEL.eval("persons | min(name)", party);
    ...
    void maxStringField() {
        ...
        Object result = JPEL.eval("persons | max(name)", party);
    ...
    void countEmptyResult() {
        ...
        Object result = JPEL.eval("persons[age > 30] | count()", party);
    ...
    void avgEmptyResultIsZero() {
        ...
        Object result = JPEL.eval("persons[age > 30] | avg(age)", party);
    ...
    void aggregationWithParameter() {
        ...
        Expression expr = JPEL.compile("products[price >= :minPrice] | sum(price)");
